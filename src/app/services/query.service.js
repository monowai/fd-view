export default class QueryService {
  ...
  concept(route, params) {
    return this._http.post(`${this._cfg.engineUrl()}/api/v1/concept/${route}`, params).then(res => res.data);
  }

  query(queryName, params) {
    return this._http.post(`${this._cfg.engineUrl()}/api/v1/query/${queryName}/`, params).then(res => res.data);
  }
  ...
  tagCloud(searchText, documents, fortress, tags, relationships) {
    ...
    return this._http.post(`${this._cfg.engineUrl()}/api/v1/query/tagcloud/`, tagCloudParams).then(res => res.data);
  }
